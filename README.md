...
The website consists of multiple interconnected pages, each focusing on a different aspect of the bioinformatics workflow:

- **Home**  
  An overview of the course recap and the purpose of the website.

- **Research & Resources**  
  A collection of essential platforms and tools for scientific literature search, biological databases, writing, and research known in the broad sense.
...
All external resources and tools referenced are publicly available and cited within the relevant sections of the website.
All content was based on the materials available on the shared presentations, as well as my own personal analysis.
